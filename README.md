...
This repository documents my journey through **LeetCode**, focusing on writing clean, efficient, and well-documented Python code. Each solution includes the algorithm implementation and, where applicable, test cases to verify correctness.

**Goals:**

- 🧠 Deepen understanding of DSA (Data Structures & Algorithms).
- ⚡️ Optimize for Time and Space complexity.
- 🧹 Maintain strictly typed and Pythonic code.

---

## 📂 Repository Structure

The project is structured to make navigation intuitive. Each problem resides in its own directory, often accompanied by visual assets or notes.

```text
/
├── LeetCode/
│   ├── 1. Two Sum/              # Problem Directory
│   │   ├── twoSum.py            # Python Solution
│   │   └── twoSum.png           # Problem/Submission Screenshot
│   ├── 9. Palindrome Number/
│   │   └── ...
│   └── ...
...
To run a specific solution, navigate to its directory and execute the script:
...
2. Create a new **Branch** (`git checkout -b feature/LeetCodeSolution`).
3. **Commit** your changes (`git commit -m 'Add solution for Problem X'`).
4. **Push** to the branch (`git push origin feature/leetCodeSolution`).
