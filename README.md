...
| 0005 | **Longest Palindromic Substring** | 🟡 Medium | [Python](./LeetCode/5.%20Longest%20Palindromic%20Substring/longestPalindrome.py) | String, Dynamic Programming |
...
| 0049 | **Group Anagrams** | 🟡 Medium | [Python](./LeetCode/49.%20Group%20Anagrams/groupAnagrams.py) | Array, Hash Table, String, Sorting |
...
| 0071 | **Simplify Path** | 🟡 Medium | [Python](./LeetCode/71.%20Simplify%20Path/simplifyPath.py) | String, Stack |
...
| 0134 | **Gas Station** | 🟡 Medium | [Python](./LeetCode/134.%20Gas%20Station/canCompleteCircuit.py) | Array, Greedy |
...
| 0141 | **Linked List Cycle** | 🟢 Easy | [Python](./LeetCode/141.%20Linked%20List%20Cycle/hasCycle.py) | Hash Table, Linked List, Two Pointers |
